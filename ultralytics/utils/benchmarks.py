...
class RF100Benchmark:
        ...
        with open(ds_link_txt) as file:
            for line in file:
                try:
                    ...
                    self.ds_cfg_list.append(Path.cwd() / proj_version / "URPC2019.yaml")
                except Exception:
                    continue
    ...
    def fix_yaml(path):
        ...
        Examples:
            >>> RF100Benchmark.fix_yaml("path/to/URPC2019.yaml")
        """
    ...
    def evaluate(self, yaml_path, val_log_file, eval_log_file, list_ind):
        ...
        Examples:
            ...
            >>> benchmark = RF100Benchmark()
            >>> benchmark.evaluate("path/to/URPC2019.yaml", "path/to/val_log.txt", "path/to/eval_log.txt", 0)
        """
        skip_symbols = ["🚀", "⚠️", "💡", "❌"]
