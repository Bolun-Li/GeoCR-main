...
def yaml_save(file="URPC2019.yaml", data=None, header=""):
    """
    Save YAML data to a file.

    Args:
        file (str, optional): File name. Default is 'URPC2019.yaml'.
...
def yaml_load(file="URPC2019.yaml", append_filename=False):
    """
